...
void pt_balance_generator_2023ppRef_MC_6s()
{
    ...
    // ifstream myfile("filenames/filenames_MC_ppRef_2023_7s.txt");
    // ifstream myfile("filenames/filenames_MC_ppRef_2023_8s.txt");
    // ifstream myfile("filenames/filenames_MC_ppRef_2023_9s.txt");
    // ifstream myfile("filenames/filenames_MC_ppRef_2023_5s.txt");
    ...
    // TFile *f1 = new TFile("pt_balance_MC_ppRef_2023_5s.root", "recreate");
    TFile *f1 = new TFile("pt_balance_MC_ppRef_2023_6s.root", "recreate");
    // TFile *f1 = new TFile("pt_balance_MC_ppRef_2023_7s.root", "recreate");
    // TFile *f1 = new TFile("pt_balance_MC_ppRef_2023_8s.root", "recreate");
    // TFile *f1 = new TFile("pt_balance_MC_ppRef_2023_9s.root", "recreate");
    f1->cd();
